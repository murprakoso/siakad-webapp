                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    ...
                                    <div class="text-center mb-2">
                                        <span class="small">Silahkan login menggunakan akun Siswa</span>
                                    </div>
                                </div>
                                @include('partials._flash')
                                <!-- Login Form -->
                                {!! html()->form('POST', route('siswa.login.post'))->class('user')->open() !!}
                                <div class="form-group">
                                    {!! html()->text('nisn')->class('form-control form-control-user')->id('nisn')->placeholder('Masukkan NISN...')->required() !!}
                                </div>
                                <div class="form-group">
